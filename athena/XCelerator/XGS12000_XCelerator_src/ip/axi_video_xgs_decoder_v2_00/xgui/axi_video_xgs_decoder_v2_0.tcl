...
source [file join [file dirname [file dirname [info script]]] gui/axi_video_xgs_decoder_v2_0.gtcl]

# Definitional proc to organize widgets for parameters.
proc init_gui { IPINST } {
  ipgui::add_param $IPINST -name "Component_Name"
  ipgui::add_param $IPINST -name "C_NROF_DATACONN" -widget comboBox
  ipgui::add_param $IPINST -name "C_AXIS_TDATA_WIDTH"
  ipgui::add_param $IPINST -name "C_USEEXT_EN" -widget comboBox
  ipgui::add_param $IPINST -name "NumberOffEnables" -widget comboBox

}

proc update_PARAM_VALUE.C_AXIS_TDATA_WIDTH { PARAM_VALUE.C_AXIS_TDATA_WIDTH PARAM_VALUE.C_NROF_DATACONN PARAM_VALUE.C_INPUT_DATAWIDTH } {
	...
	set_property value [gen_USERPARAMETER_C_AXIS_TDATA_WIDTH_VALUE $values(C_NROF_DATACONN) $values(C_INPUT_DATAWIDTH)] $C_AXIS_TDATA_WIDTH
}
...
proc update_PARAM_VALUE.C_USEEXT_EN { PARAM_VALUE.C_USEEXT_EN } {
	# Procedure called to update C_USEEXT_EN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_USEEXT_EN { PARAM_VALUE.C_USEEXT_EN } {
	# Procedure called to validate C_USEEXT_EN
	return true
}

proc update_PARAM_VALUE.NumberOffEnables { PARAM_VALUE.NumberOffEnables } {
	# Procedure called to update NumberOffEnables when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NumberOffEnables { PARAM_VALUE.NumberOffEnables } {
	# Procedure called to validate NumberOffEnables
	return true
}
...
proc update_MODELPARAM_VALUE.C_USEEXT_EN { MODELPARAM_VALUE.C_USEEXT_EN PARAM_VALUE.C_USEEXT_EN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_USEEXT_EN}] ${MODELPARAM_VALUE.C_USEEXT_EN}
}
