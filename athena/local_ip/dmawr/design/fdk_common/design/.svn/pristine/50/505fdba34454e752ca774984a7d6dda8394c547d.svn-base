----------------------------------------------------------------------
--  $HeadURL: svn://brainstorm/svn_ipcore/trunk/Matrox/Imaging/FDK/hw/cores/common/design/stream_unpacker_mux.vhd $
--  $Revision: 8445 $
--  $Date: 2009-02-11 19:07:39 -0500 (Wed, 11 Feb 2009) $
--  $Author: palepin $
--
--  DESCRIPTION: Stream Unpack Multiplexer core module
--
--
--  Functionality
--
...
--              |                                                                       |                                                                                
--  MODE_2C_8   |                                   Bn-1 An-1 Bn-2 An-2 .. B1 A1 B0 A0  |                                         Bn-1 Bn-2 .. B1 B0 An-1 An-2 .. A1 A0  
--              |                                                                       |                                                                                
--  MODE_2C_16  |                                   Bn-1 Bn-2 An-1 An-2 .. B1 B0 A1 A0  |                                         Bn-1 Bn-2 .. B1 B0 An-1 An-2 .. A1 A0  
--              |                                                                       |                                                                                
--  MODE_3C_8   |                   Cn-1 Bn-1 An-1 Cn-2 Bn-2 An-2 .. C1 B1 A1 C0 B0 A0  |                      Cn-1 Cn-2 .. C1 C0 Bn-1 Bn-2 .. B1 B0 An-1 An-2 .. A1 A0  
--              |                                                                       |                                                                                
--  MODE_3C_16  |                   Cn-1 Cn-2 Bn-1 Bn-2 An-1 An-2 .. C1 C0 B1 B0 A1 A0  |                      Cn-1 Cn-2 .. C1 C0 Bn-1 Bn-2 .. B1 B0 An-1 An-2 .. A1 A0  
--              |                                                                       |                                                                                
--  MODE_4C_8   |   Dn-1 Cn-1 Bn-1 An-1 Dn-2 Cn-2 Bn-2 An-2 .. D1 C1 B1 A1 D0 C0 B0 A0  |   Dn-1 Dn-2 .. D1 D0 Cn-1 Cn-2 .. C1 C0 Bn-1 Bn-2 .. B1 B0 An-1 An-2 .. A1 A0  
--              |                                                                       |                                                                                
--  MODE_4C_16  |   Dn-1 Dn-2 Cn-1 Cn-2 Bn-1 Bn-2 An-1 An-2 .. D1 D0 C1 C0 B1 B0 A1 A0  |   Dn-1 Dn-2 .. D1 D0 Cn-1 Cn-2 .. C1 C0 Bn-1 Bn-2 .. B1 B0 An-1 An-2 .. A1 A0  
--
-- 
--
-----------------------------------------------------------------------
...
end stream_unpacker_mux;




architecture functional of stream_unpacker_mux is
...
gen_mux : for b in S_DATA_BYTES-1 downto 0 generate
  ...
  sel(b) <= 
            ...
            -- MODE_2C_8
            2 * (b mod S_DATA_BYTES_PER_CONTEXT) + b / S_DATA_BYTES_PER_CONTEXT
              when pack_mode = MODE_2C_8 and b < 2*S_DATA_BYTES_PER_CONTEXT else

            -- MODE_2C_16
            4 * (b / 2 mod (S_DATA_BYTES_PER_CONTEXT / 2)) + b mod 2 +  b / S_DATA_BYTES_PER_CONTEXT * 2
              when (pack_mode = MODE_2C_16 and b < 2*S_DATA_BYTES_PER_CONTEXT) or NUMBER_OF_CONTEXTS = 2 else

            -- MODE_3C_8
            3 * (b mod S_DATA_BYTES_PER_CONTEXT) + b / S_DATA_BYTES_PER_CONTEXT
              when pack_mode = MODE_3C_8 and b < 3*S_DATA_BYTES_PER_CONTEXT else

            -- MODE_3C_16
            6 * (b / 2 mod (S_DATA_BYTES_PER_CONTEXT / 2)) + b mod 2 +  b / S_DATA_BYTES_PER_CONTEXT * 2
              when (pack_mode = MODE_3C_16 and b < 3*S_DATA_BYTES_PER_CONTEXT) or NUMBER_OF_CONTEXTS = 3 else

            -- MODE_4C_8
            4 * (b mod S_DATA_BYTES_PER_CONTEXT) + b / S_DATA_BYTES_PER_CONTEXT
              when pack_mode = MODE_4C_8 else

            -- MODE_4C_16
            8 * (b / 2 mod (S_DATA_BYTES_PER_CONTEXT / 2)) + b mod 2 +  b / S_DATA_BYTES_PER_CONTEXT * 2;
