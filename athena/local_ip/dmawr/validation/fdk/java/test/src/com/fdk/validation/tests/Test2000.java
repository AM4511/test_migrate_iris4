/**
 * This class defines test 2000. Test2000 is a simple test that DMA one streamed image from the SDRAM model
 * to the stream input model.
 * 
...
/**
 * This class defines test 2000. Test2000 is a simple test that streams an image to the DMA write TU that 
 * stores it in SDRAM memory. The SDRAM contents image is compared with the input image. The simulation 
 * is stopped on the reception of an End Of Frame interrupt.
 * <p>
 ...
 * </ul>
 */
public class Test2000 extends FDKTest {

	/**
	 * @param context
	 *            The simulation context used for running this test.
	 */
	public Test2000(FDKContext context)
	{
		super(context, "test2000");
	}
