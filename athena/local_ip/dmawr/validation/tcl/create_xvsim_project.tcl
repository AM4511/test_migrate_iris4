...
#
# Example      : source $env(IRIS4)/athena/local_ip/dmawr/validation/tcl/create_xvsim_project.tcl
#
# ##################################################################################
...
set AXI_SYSTEM_BD_FILE ${TCL_DIR}/testbench_ipi.tcl
...
set BD_FILE [get_files "*testbench_ipi.bd"]
