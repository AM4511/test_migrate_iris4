...
# 
# set base_path $env(IRIS4)/athena/local_ip/ip/validation/vivado
...
# Set the project dir
set base_path $env(IRIS4)/athena/local_ip/ip/validation
...
create_project ${_xil_proj_name_} $proj_dir  -part ${DEVICE} -force
...
set_property "ip_repo_paths" "[file normalize "$base_path/.."]" $obj
...
source $base_path/bd/BD_XGS12000_receiver_VIPlight.tcl
