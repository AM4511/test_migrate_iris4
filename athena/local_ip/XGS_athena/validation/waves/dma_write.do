...
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/dma_idle
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/dma_pcie_state
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/start_of_frame
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/line_ready
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/line_transfered
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/end_of_dma
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/read_enable_out
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/read_address
add wave -noupdate -expand -group dma_write -expand -group {axi_stream_in I/F} /testbench/DUT/xdmawr2tlp/xdma_write/read_data
...
add wave -noupdate -expand -group dma_write -expand -group {TLP I/F} -color {Orange Red} /testbench/DUT/xdmawr2tlp/xdma_write/tlp_req_to_send
add wave -noupdate -expand -group dma_write -expand -group {TLP I/F} -color {Orange Red} /testbench/DUT/xdmawr2tlp/xdma_write/tlp_grant
...
add wave -noupdate -expand -group dma_write -expand -group {TLP I/F} -color Magenta /testbench/DUT/xdmawr2tlp/xdma_write/tlp_src_rdy_n
add wave -noupdate -expand -group dma_write -expand -group {TLP I/F} -color Magenta /testbench/DUT/xdmawr2tlp/xdma_write/tlp_dst_rdy_n
add wave -noupdate -expand -group dma_write -expand -group {TLP I/F} -color Magenta /testbench/DUT/xdmawr2tlp/xdma_write/tlp_data
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {3953962778 ps} 0}
...
update
WaveRestoreZoom {3953867640 ps} {3954166901 ps}
