...
add wave -noupdate -expand -group xgs_mono_pipeline -expand -group {AXI STream input} -expand -subitemconfig {/testbench/DUT/xgs_mono_pipeline_inst/sclk_tuser(3) {-color Cyan} /testbench/DUT/xgs_mono_pipeline_inst/sclk_tuser(2) {-color Cyan}} /testbench/DUT/xgs_mono_pipeline_inst/sclk_tuser
...
add wave -noupdate -expand -group xgs_mono_pipeline -color {Cornflower Blue} /testbench/DUT/xgs_mono_pipeline_inst/sclk_full
...
add wave -noupdate -expand -group xgs_mono_pipeline -color Gold /testbench/DUT/xgs_mono_pipeline_inst/aclk_empty
...
add wave -noupdate -expand -group xgs_mono_pipeline /testbench/DUT/xgs_mono_pipeline_inst/aclk_acknowledge
...
add wave -noupdate -expand -group xgs_mono_pipeline -expand -group {AXI Stream output} -expand /testbench/DUT/xgs_mono_pipeline_inst/aclk_tuser
add wave -noupdate -expand -group xgs_mono_pipeline -expand -group {AXI Stream output} -color {Slate Blue} /testbench/DUT/xgs_mono_pipeline_inst/aclk_tlast
...
WaveRestoreCursors {{Cursor 1} {1198764373 ps} 0} {{Cursor 2} {1992462296 ps} 0}
...
update
WaveRestoreZoom {1194547256 ps} {1199348392 ps}
