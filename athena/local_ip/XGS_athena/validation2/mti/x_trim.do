...
add wave -noupdate -expand -group x_trim -expand -group {Command FiFo (write I/F)} /testbench/DUT/aclk_cmd_sync
add wave -noupdate -expand -group x_trim -expand -group {Command FiFo (write I/F)} /testbench/DUT/aclk_cmd_size
add wave -noupdate -expand -group x_trim -expand -group {Command FiFo (write I/F)} /testbench/DUT/aclk_cmd_buff_ptr
add wave -noupdate -expand -group x_trim -expand -group {Command FiFo (write I/F)} /testbench/DUT/aclk_cmd_last_ben
