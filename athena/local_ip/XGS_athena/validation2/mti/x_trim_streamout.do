...
add wave -noupdate -expand -group x_trim_streamout -expand -group {Command fields} /testbench/DUT/x_trim_streamout_inst/bclk_cmd_sync
...
add wave -noupdate -expand -group x_trim_streamout -expand -group {Align packer} -color Gold /testbench/DUT/x_trim_streamout_inst/bclk_align_packer_valid_vect
...
add wave -noupdate -expand -group x_trim_streamout -expand -group {Align packer} -color Gold /testbench/DUT/x_trim_streamout_inst/bclk_align_packer_user
...
add wave -noupdate -expand -group x_trim_streamout -expand -group {Axi streamout I/F} /testbench/DUT/x_trim_streamout_inst/bclk_tuser
...
WaveRestoreCursors {{Cursor 1} {2854262 ps} 0}
...
update
WaveRestoreZoom {2359716 ps} {3373762 ps}
