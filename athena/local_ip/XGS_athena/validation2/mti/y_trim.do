...
add wave -noupdate -expand -group y_trim -group y_trim /testbench/DUT/y_trim_inst/aclk_y_start
add wave -noupdate -expand -group y_trim -group y_trim /testbench/DUT/y_trim_inst/aclk_y_size
...
add wave -noupdate -expand -group y_trim -expand -group {Stream Input I/F} /testbench/DUT/y_trim_inst/aclk_tuser
...
add wave -noupdate -expand -group y_trim -color Gold /testbench/DUT/y_trim_inst/aclk_state
add wave -noupdate -expand -group y_trim -expand -group {Line counter} /testbench/DUT/y_trim_inst/aclk_y_stop
add wave -noupdate -expand -group y_trim -expand -group {Line counter} /testbench/DUT/y_trim_inst/aclk_line_cntr
add wave -noupdate -expand -group y_trim -expand -group {Line counter} /testbench/DUT/y_trim_inst/aclk_line_valid
add wave -noupdate -expand -group y_trim -color White /testbench/DUT/y_trim_inst/aclk_ack
...
WaveRestoreCursors {{Cursor 1} {5211548 ps} 0}
