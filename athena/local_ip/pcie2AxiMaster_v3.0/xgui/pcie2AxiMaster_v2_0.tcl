...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set Interrupts [ipgui::add_page $IPINST -name "Interrupts" -display_name {Host Interrupts}]
  ...
  set AXI_ID_WIDTH [ipgui::add_param $IPINST -name "AXI_ID_WIDTH" -parent ${Axi} -widget comboBox]
  set_property tooltip {Set the Axi transaction Id port width} ${AXI_ID_WIDTH}
