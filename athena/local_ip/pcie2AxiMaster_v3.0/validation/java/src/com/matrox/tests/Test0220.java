 ...
 * <p>
 */
public class Test0220 extends FDKTest {

	/**
	 * @param context The simulation context used for running this test.
	 */
	public Test0220(FDKContext context) {
		super(context, "Test0220");
	}
	...
	public void run() {
		...
		for (int i = 0; i < 2; i++) {
			long address = BAR0 + 2*i;
			int data = 0xdeadbeef & ( 0xffff<< i*16);
			
			modelPCIe.MemWrite(32, address, 2, data);
