...
public class MVB {
	...
	private Cfintek_F81216[] fintek81216;
	...
	public MVB(FDKDirectory testDirectory, PCIeNSys pcieRoot)
	{
		...
		// Create the Fintek UART register files
		this.fintek81216 = new Cfintek_F81216[2];
		for (int i = 0; i < fintek81216.length; i++)
		{
			this.fintek81216[i] = new Cfintek_F81216();
	...
	public void setVMETimeoutMax(int valueAsClockCycle)
	{
		...
		pcieRoot.getCmdFile().append("# Set VME MAX TIME OUT Value:");
		pcieRoot.MemWrite(vme_timeoutRegister);
	}
	...
	/**
	 * @return the fintek81216
	 */
	public Cfintek_F81216[] getFintek81216()
	{
		return fintek81216;
	}
	...
	/**
	 * @return the fintek81216[index]
	 */
	public Cfintek_F81216 getFintek81216(int index)
	{
		return fintek81216[index];
	}
	...
	public void init(long[] BaseAddrReg)
	{
		...
		// Set the register file base address in java
		this.mvbRegFile.setBaseAddress((int) BaseAddrReg[0]);

		///////////////////////////////////////////////////////////////////////
		// BAR2: VME Window apperture A24/A16
		///////////////////////////////////////////////////////////////////////
