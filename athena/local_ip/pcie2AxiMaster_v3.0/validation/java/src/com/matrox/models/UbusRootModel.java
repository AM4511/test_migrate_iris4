...
public class UbusRootModel extends ValidationModel implements IUbusMaster{
	CMVBUbus ubusRegFile;

	public static final String WAIT_NANO_SEC = "WAIT_NANO_SEC";
	public static final String TB_WAIT1_UBUS = "TB_WAIT1_UBUS";
	public static final String WAIT_NB_CLK = "WAIT_NB_CLK";
	public static final String TB_WAIT2_UBUS = "TB_WAIT2_UBUS";
	public static final String WAIT_UNTIL_NANO_SEC = "WAIT_UNTIL_NANO_SEC";
	public static final String TB_WAIT3_UBUS = "TB_WAIT3_UBUS";
	...
	public UbusRootModel(FDKDirectory testDirectory)
	{
		super(testDirectory);
	...
	public void UbusWrite(CRegister register)
	{
		...
		//Build line to write
		String command = String.format("e %04X %08X", BaseAddress, Value);
	...
	{
		//Build line to write
		String command = String.format("e %04X %08X", address, value);
