...
/**
 * This class defines Test0201.
 * <p>
 * <b>Test Family:</b> PCIExpress BAR0 read/write accesses
 * <p>
 * <b>Description:</b> Write 256 DWORD and read it back in the BAR0
 * <p>
 */
public class Test0201 extends FDKTest {

	/**
	 * @param context
	 *            The simulation context used for running this test.
	 */
	public Test0201(FDKContext context) {
		super(context, "Test0201");
	}
	...
	public void run() {
		...
		for (int i = 0; i < NUMBER_OF_LOOP; i++) {
			...
			modelPCIe.Delay("WAIT_NANO_SEC", 50);
