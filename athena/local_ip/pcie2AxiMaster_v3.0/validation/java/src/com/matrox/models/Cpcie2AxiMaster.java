...
public class Cpcie2AxiMaster  extends CRegisterFile {
   ...
   public Cpcie2AxiMaster()
   {
      ...
      * Offset: 0x0
      ****************************************************************/
      section = new CSection(this, "info", "PCIe2AxiMaster information", 0x0);
      ...
      * Offset: 0x0
      ****************************************************************/
      register = new CRegister(section, "tag", "null", 0x0);
      ...
      ****************************************************************/
      ...
      register.addField(new CField(register, "minor", "Minor version", CField.FieldType.STATIC, 8, 8, 0x2));
