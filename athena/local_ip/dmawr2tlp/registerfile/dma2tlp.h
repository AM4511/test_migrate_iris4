...
#define FPGA_DMA2TLP_DMA_FRAME_START_ADDRESS     0x44
#define FPGA_DMA2TLP_DMA_FRAME_START_G_ADDRESS   0x4C
#define FPGA_DMA2TLP_DMA_FRAME_START_R_ADDRESS   0x54
#define FPGA_DMA2TLP_DMA_LINE_PITCH_ADDRESS      0x5C
#define FPGA_DMA2TLP_DMA_LINE_SIZE_ADDRESS       0x60
#define FPGA_DMA2TLP_DMA_CSC_ADDRESS             0x64
#define FPGA_DMA2TLP_STATUS_ACTIVE_ADDRESS       0xC0
#define FPGA_DMA2TLP_STATUS_DEBUG_ADDRESS        0xC4
...
typedef union
{
   ...
   struct
   {
      ...
      M_UINT32 grab_queue_enable : 1;   /* Bits(1:1), null */
...
} FPGA_DMA2TLP_STATUS_ACTIVE_TYPE;
...
typedef struct
{
   ...
   FPGA_DMA2TLP_DMA_FRAME_START_TYPE   frame_start[2];    /* Address offset: 0x4 */
   FPGA_DMA2TLP_DMA_FRAME_START_G_TYPE frame_start_g[2];  /* Address offset: 0xc */
   FPGA_DMA2TLP_DMA_FRAME_START_R_TYPE frame_start_r[2];  /* Address offset: 0x14 */
   FPGA_DMA2TLP_DMA_LINE_PITCH_TYPE    line_pitch;        /* Address offset: 0x1c */
   FPGA_DMA2TLP_DMA_LINE_SIZE_TYPE     line_size;         /* Address offset: 0x20 */
   FPGA_DMA2TLP_DMA_CSC_TYPE           csc;               /* Address offset: 0x24 */
...
typedef struct
{
   FPGA_DMA2TLP_STATUS_ACTIVE_TYPE active;  /* Address offset: 0x0 */
   FPGA_DMA2TLP_STATUS_DEBUG_TYPE  debug;   /* Address offset: 0x4 */
...
typedef struct
{
   ...
   M_UINT32                 rsvd1[19];  /* Padding; Size (76 Bytes) */
