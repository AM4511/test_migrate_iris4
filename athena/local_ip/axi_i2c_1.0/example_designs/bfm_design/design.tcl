proc create_ipi_design { offsetfile design_name } {
	...
	set axi_i2c_0 [ create_bd_cell -type ip -vlnv matrox.com:user:axi_i2c:1.0 axi_i2c_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores matrox.com:user:axi_i2c:1.0]]]]
