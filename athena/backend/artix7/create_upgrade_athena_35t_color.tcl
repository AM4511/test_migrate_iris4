# ##################################################################################
# File         : create_upgrade_athena_35t_color.tcl
# Description  : TCL script used to create UPGRADE COLOR athena fpga 35T. 
#
# Example      : source $env(IRIS4)/athena/backend/artix7/create_upgrade_athena_35t_color.tcl
#
# ##################################################################################
set DEBUG 0
...
if {$DEBUG == 0} {
  ...
  set myself $env(IRIS4)/athena/backend/artix7/create_upgrade_athena_35t_color.tcl
}
...
if {[file exists $myself ]} {
   ...
   set BASE_NAME             "upgrade_athena35t"
