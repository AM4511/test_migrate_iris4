...
proc create_root_design { parentCell } {
  ...
  set ext_ch_gt_drpclk_out [ create_bd_port -dir O -type clk ext_ch_gt_drpclk_out ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] $ext_ch_gt_drpclk_out
  ...
  connect_bd_net -net XGS_athena_0_irq [get_bd_pins XGS_athena_0/irq] [get_bd_pins xlconcat_1/In0]
  ...
  connect_bd_net -net pcie2AxiMaster_0_ext_ch_gt_drpclk [get_bd_ports ext_ch_gt_drpclk_out] [get_bd_pins pcie2AxiMaster_0/ext_ch_gt_drpclk]
  connect_bd_net -net pcie2AxiMaster_0_sw_irq [get_bd_pins pcie2AxiMaster_0/sw_irq] [get_bd_pins xlconcat_1/In1]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins pcie2AxiMaster_0/irq_event] [get_bd_pins xlconcat_1/dout]
