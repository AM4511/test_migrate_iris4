...
# #####################################################################################
create_clock -period ${clock_period}  -name io_hispi_clk_top    -waveform {0.000 1.285} [get_ports {xgs_hispi_sclk_p[0]}]

# HiSPi Lane 0
set_input_delay -clock [get_clocks io_hispi_clk_top] -min -add_delay ${min_delay_rise_edge} [get_ports xgs_hispi_sdata_p[0]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -max -add_delay ${max_delay_rise_edge} [get_ports xgs_hispi_sdata_p[0]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -clock_fall -min -add_delay ${min_delay_fall_edge} [get_ports xgs_hispi_sdata_p[0]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -clock_fall -max -add_delay ${max_delay_fall_edge} [get_ports xgs_hispi_sdata_p[0]]

# HiSPi Lane 8
set_input_delay -clock [get_clocks io_hispi_clk_top] -min -add_delay ${min_delay_rise_edge} [get_ports xgs_hispi_sdata_p[2]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -max -add_delay ${max_delay_rise_edge} [get_ports xgs_hispi_sdata_p[2]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -clock_fall -min -add_delay ${min_delay_fall_edge} [get_ports xgs_hispi_sdata_p[2]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -clock_fall -max -add_delay ${max_delay_fall_edge} [get_ports xgs_hispi_sdata_p[2]]

# HiSPi Lane 16
set_input_delay -clock [get_clocks io_hispi_clk_top] -min -add_delay ${min_delay_rise_edge} [get_ports xgs_hispi_sdata_p[4]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -max -add_delay ${max_delay_rise_edge} [get_ports xgs_hispi_sdata_p[4]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -clock_fall -min -add_delay ${min_delay_fall_edge} [get_ports xgs_hispi_sdata_p[4]]
set_input_delay -clock [get_clocks io_hispi_clk_top] -clock_fall -max -add_delay ${max_delay_fall_edge} [get_ports xgs_hispi_sdata_p[4]]

# #####################################################################################
# IO LANES HiSPi Bottom interface
# #####################################################################################
create_clock -period ${clock_period}  -name io_hispi_clk_bottom -waveform {0.000 1.285} [get_ports {xgs_hispi_sclk_p[1]}]

# HiSPi Lane 1
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -min -add_delay ${min_delay_rise_edge} [get_ports xgs_hispi_sdata_p[1]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -max -add_delay ${max_delay_rise_edge} [get_ports xgs_hispi_sdata_p[1]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -clock_fall -min -add_delay ${min_delay_fall_edge} [get_ports xgs_hispi_sdata_p[1]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -clock_fall -max -add_delay ${max_delay_fall_edge} [get_ports xgs_hispi_sdata_p[1]]


# HiSPi Lane 9
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -min -add_delay ${min_delay_rise_edge} [get_ports xgs_hispi_sdata_p[3]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -max -add_delay ${max_delay_rise_edge} [get_ports xgs_hispi_sdata_p[3]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -clock_fall -min -add_delay ${min_delay_fall_edge} [get_ports xgs_hispi_sdata_p[3]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -clock_fall -max -add_delay ${max_delay_fall_edge} [get_ports xgs_hispi_sdata_p[3]]


# HiSPi Lane 17
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -min -add_delay ${min_delay_rise_edge} [get_ports xgs_hispi_sdata_p[5]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -max -add_delay ${max_delay_rise_edge} [get_ports xgs_hispi_sdata_p[5]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -clock_fall -min -add_delay ${min_delay_fall_edge} [get_ports xgs_hispi_sdata_p[5]]
set_input_delay -clock [get_clocks io_hispi_clk_bottom] -clock_fall -max -add_delay ${max_delay_fall_edge} [get_ports xgs_hispi_sdata_p[5]]
...
# ###################################################################################################################
set src_pin [get_pins xsystem_pb_wrapper/system_pb_i/pcie2AxiMaster_0/U0/xxil_pcie/pcie_7x_0_xil_wrapper/inst/inst/gt_top_i/pipe_wrapper_i/pipe_clock_int.pipe_clock_i/mmcm_i/CLKIN1] 
set clk_pin [get_pins xsystem_pb_wrapper/system_pb_i/pcie2AxiMaster_0/U0/xxil_pcie/pcie_7x_0_xil_wrapper/inst/inst/gt_top_i/pipe_wrapper_i/pipe_clock_int.pipe_clock_i/mmcm_i/CLKOUT2]
