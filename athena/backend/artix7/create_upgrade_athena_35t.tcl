# ##################################################################################
# File         : create_upgrade_athena_35t.tcl
# Description  : TCL script used to create UPGRADE MONO athena fpga 35T. 
#
# Example      : source $env(IRIS4)/athena/backend/artix7/create_upgrade_athena_35t.tcl
#
# ##################################################################################
set DEBUG 0
...
if {$DEBUG == 0} {
  ...
  set myself $env(IRIS4)/athena/backend/artix7/create_upgrade_athena_35t.tcl
}
