...
proc create_root_design { parentCell } {
  ...
  set s_axil_if [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axil_if ]
  ...
  # Create ports
  set axiClk100MHz [ create_bd_port -dir I -type clk axiClk100MHz ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000} \
 ] $axiClk100MHz
  set axiReset_n [ create_bd_port -dir I -type rst axiReset_n ]
  set dma_irq [ create_bd_port -dir O dma_irq ]
  set idelayClk [ create_bd_port -dir I -type clk idelayClk ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net s_axil_if_1 [get_bd_intf_ports s_axil_if] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  ...
  connect_bd_net -net ACLK_1 [get_bd_ports axiClk100MHz] [get_bd_pins axiHiSPi_0/axi_clk] [get_bd_pins axiXGS_controller_0/s_axi_aclk] [get_bd_pins axi_i2c_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins dmawr2tlp_0/sys_clk]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces s_axil_if] [get_bd_addr_segs axiXGS_controller_0/S_AXI/S_AXI_reg] SEG_axiXGS_controller_0_S_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00002000 [get_bd_addr_spaces s_axil_if] [get_bd_addr_segs axi_i2c_0/S_AXI/S_AXI_reg] SEG_axi_i2c_0_S_AXI_reg
  create_bd_addr_seg -range 0x00001000 -offset 0x00003000 [get_bd_addr_spaces s_axil_if] [get_bd_addr_segs dmawr2tlp_0/s_axi/reg0] SEG_dmawr2tlp_0_reg0
