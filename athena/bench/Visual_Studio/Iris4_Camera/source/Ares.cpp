...
void CAres::ArbiterTest(void)
{
    if (rAres_ptr.arbiter.arbiter_capabilities.f.tag == 0xAAB) {
        ...
        if (rAres_ptr.arbiter.agent[0].f.rec != 1) printf("Arbiter ERROR: REC_0 dois etre a 1\n");
        if (rAres_ptr.arbiter.agent[0].f.ack != 1) printf("Arbiter ERROR: ACK_0 dois etre a 1\n");
        if (rAres_ptr.arbiter.agent[1].f.rec != 0) printf("Arbiter ERROR: REC_1 dois etre a 0\n");
        if (rAres_ptr.arbiter.agent[1].f.ack != 0) printf("Arbiter ERROR: ACK_1 dois etre a 0\n");
        rAres_ptr.arbiter.agent[0].f.done = 1;
        if (rAres_ptr.arbiter.agent[0].f.rec != 0) printf("Arbiter ERROR: REC_0 dois etre a 0\n");
        if (rAres_ptr.arbiter.agent[0].f.ack != 0) printf("Arbiter ERROR: ACK_0 dois etre a 0\n");
        if (rAres_ptr.arbiter.agent[1].f.rec != 0) printf("Arbiter ERROR: REC_1 dois etre a 0\n");
        if (rAres_ptr.arbiter.agent[1].f.ack != 0) printf("Arbiter ERROR: ACK_1 dois etre a 0\n");

        // REQ1 -> DONE1
        rAres_ptr.arbiter.agent[1].f.req = 1;
        if (rAres_ptr.arbiter.agent[1].f.rec != 1) printf("Arbiter ERROR: REC_1 dois etre a 1\n");
        if (rAres_ptr.arbiter.agent[1].f.ack != 1) printf("Arbiter ERROR: ACK_1 dois etre a 1\n");
        if (rAres_ptr.arbiter.agent[0].f.rec != 0) printf("Arbiter ERROR: REC_0 dois etre a 0\n");
        if (rAres_ptr.arbiter.agent[0].f.ack != 0) printf("Arbiter ERROR: ACK_0 dois etre a 0\n");
      ...
      printf("No arbiter found in ARES fpga\n");
}
