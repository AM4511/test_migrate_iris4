...
Cares::Cares(string name, u64 pciBAR0, u64 pciBAR2)
{
...
volatile u32* Cares::setAxiWindow(u32 id, u32 start, u32 stop, u32 axi_offset)
{
...
void Cares::setAxiWindowTranslationOffset(u32 id, u32 axi_offset)
{
	regFilePtr->axi_window[id].axi_translation.u32 = axi_offset;
}

void Cares::disableAllWindow()
{
	for (u32 i = 0; i < 4; i++)
	{
		disableWindow(i);
...
void Cares::disableWindow(u32 windowID)
{
...
volatile u32* Cares::allocate(u64 pcieBAR, u32 barSize, MIL_ID* milBuffer)
{
...
void Cares::printFPGAInfo()
{
	...
	Cares::FirmwareType  bitstreamType = getFirmwareType();
	switch (bitstreamType)
	{
	case Cares::MIL_UPGRADE:
		cout << "Firmware type : MIL_UPGRADE" << endl;
		break;
	case Cares::NPI_GOLDEN:
		cout << "Firmware type : NPI_GOLDEN" << endl;
		break;
	case Cares::ENGINEERING:
