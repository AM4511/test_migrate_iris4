proc create_ipi_design { offsetfile design_name } {
	...
	set offset_file "${bd_path}/Lpc_to_AXI_prodcons_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef Lpc_to_AXI_prodcons_tb_include_vh_"
	puts $fp "`define Lpc_to_AXI_prodcons_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/Lpc_to_AXI_prodcons_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "Lpc_to_AXI_prodcons_bfm_${i}"
...
remove_files -quiet -fileset sim_1 Lpc_to_AXI_prodcons_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top Lpc_to_AXI_prodcons_tb [get_filesets sim_1]
