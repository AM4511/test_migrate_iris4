...
--               C:/work/iris3/Ares_A7/cores/xil_cores_artix7/system_monitor/system_monitor_funcsim.vhdl
...
entity system_monitor is
  ...
  attribute NotValidForBitStream of system_monitor : entity is true;
  attribute core_generation_info : string;
  attribute core_generation_info of system_monitor : entity is "system_monitor,xadc_wiz_v3_1,{component_name=system_monitor,enable_axi=false,enable_axi4stream=false,dclk_frequency=62,enable_busy=true,enable_convst=false,enable_convstclk=false,enable_dclk=true,enable_drp=true,enable_eoc=true,enable_eos=true,enable_vbram_alaram=false,enable_vccddro_alaram=false,enable_Vccint_Alaram=true,enable_Vccaux_alaram=trueenable_vccpaux_alaram=false,enable_vccpint_alaram=false,ot_alaram=false,user_temp_alaram=true,timing_mode=continuous,channel_averaging=16,sequencer_mode=on,startup_channel_selection=contineous_sequence}";
end system_monitor;

architecture STRUCTURE of system_monitor is
...
U0: unisim.vcomponents.XADC
    generic map(
      ...
      IS_DCLK_INVERTED => '0',
      SIM_DEVICE => "7SERIES",
      SIM_MONITOR_FILE => "c:/work/iris3/Ares_A7/cores/xil_cores_artix7/system_monitor/system_monitor/simulation/functional/design.txt"
    )
        port map (
      ALM(7) => alarm_out,
