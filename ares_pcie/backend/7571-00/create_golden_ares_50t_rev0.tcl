...
#
# Example      : source $env(IRIS4)/ares_pcie/backend/7571-00/create_golden_ares_50t_rev0.tcl
# 
# ##################################################################################
set DEBUG 0
...
if {${DEBUG} == 1} {
  set myself $env(IRIS4)/ares_pcie/backend/7571-00/create_golden_ares_50t_rev0.tcl
} else {
...
if {[file exists $myself ]} {
   ...
   set BASE_NAME  golden_ares_7571_00_a50t
