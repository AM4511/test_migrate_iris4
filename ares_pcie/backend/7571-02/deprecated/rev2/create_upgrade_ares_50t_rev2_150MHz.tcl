...
#
# Example      : source $env(IRIS4)/ares_pcie/backend/7571-02/create_upgrade_ares_50t_rev2_150MHz.tcl
# 
# set NO_REPORT  1
# set NO_ARCHIVE 1
# ##################################################################################
...
if {${DEBUG} == 1} {
  set myself $env(IRIS4)/ares_pcie/backend/7571-02/create_upgrade_ares_50t_rev2_150MHz.tcl
} else {
...
if {[file exists $myself ]} {
   ...
   set BASE_NAME  upgrade_ares_7571_02_a50t_HR150
   set DEVICE "xc7a50ticpg236-1L"

   set AXI_SYSTEM_BD_FILE ${BACKEND_DIR}/system_pcie_hyperram_hr150MHz.tcl
   set HYPERRAM_SDC_FILE  ${BACKEND_DIR}/hyperbus_hr150MHz.sdc
