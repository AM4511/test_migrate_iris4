...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net util_ds_buf_0_BUFG_O [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins util_ds_buf_0/BUFG_O]
