...
#
# Example      : source $env(IRIS4)/ares_pcie/backend/7571-02/create_golden_ares_50t_rev2.tcl
# 
# set NO_REPORT  1
# set NO_ARCHIVE 1
# ##################################################################################
...
if {${DEBUG} == 1} {
  set myself $env(IRIS4)/ares_pcie/backend/7571-02/create_golden_ares_50t_rev2.tcl
} else {
...
if {[file exists $myself ]} {
   ...
   set BASE_NAME  golden_ares_7571_02_a50t
