...
###################################################################################
create_generated_clock -name pll_ncsi_clk_int [get_pins -hierarchical -filter {NAME =~ */ares_pb_i/clk_wiz_0/inst/plle2_adv_inst/CLKOUT2}]
create_generated_clock -name pll_ncsi_clk_io  [get_pins -hierarchical -filter {NAME =~ */ares_pb_i/clk_wiz_0/inst/plle2_adv_inst/CLKOUT3}]


###################################################################################
## NCSI output clock : The FPGA generates the NCSI clocks for the i210
###################################################################################
create_generated_clock -name ncsi_clk_io -source  [get_pins -hierarchical -filter {NAME =~ */ares_pb_i/clk_wiz_0/inst/plle2_adv_inst/CLKOUT3}]  -divide_by 1 [get_ports ncsi_clk]
