...
## inverted by 180 Deg. 
###################################################################################
create_generated_clock -name ncsi_clk_io -source  [get_pins -hierarchical -filter {NAME =~ */ares_pb_i/clk_wiz_0/inst/plle2_adv_inst/CLKOUT3}] -invert -divide_by 1 [get_ports ncsi_clk]
