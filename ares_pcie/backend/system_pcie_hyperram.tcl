...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk50MHz [get_bd_pins clk_wiz_0/clk50MHz] [get_bd_pins mii_to_rmii_0/ref_clk]
