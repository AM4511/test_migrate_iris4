...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net aresetn_1 [get_bd_ports reset_n] [get_bd_pins axiRpc_reset/ext_reset_in] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins system_reset/ext_reset_in]
  ...
  connect_bd_net -net clk_100MHz_1 [get_bd_ports clk_100MHz] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins rpc2_ctrl_controller_0/sys_clk]
  connect_bd_net -net clk_wiz_0_clk125MHz [get_bd_pins axi_ethernet_0/gtx_clk] [get_bd_pins clk_wiz_0/clk125MHz]
  connect_bd_net -net clk_wiz_0_clk50MHz [get_bd_ports ncsi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk50MHz] [get_bd_pins mii_to_rmii_0/ref_clk]
  connect_bd_net -net clk_wiz_0_clkAxiRpc [get_bd_pins axiRpc_reset/slowest_sync_clk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins clk_wiz_0/clkAxiRpc] [get_bd_pins rpc2_ctrl_controller_0/AXIm_ACLK]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins axiRpc_reset/dcm_locked] [get_bd_pins clk_wiz_0/locked] [get_bd_pins system_reset/dcm_locked]
