...
proc create_root_design { parentCell } {
  ...
  # Create instance: hb_pll, and set properties
  set hb_pll [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 hb_pll ]
  set_property -dict [ list \
   CONFIG.CLKOUT1_DRIVES {BUFG} \
   CONFIG.CLKOUT1_JITTER {170.632} \
   CONFIG.CLKOUT1_PHASE_ERROR {203.313} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {166.000} \
   CONFIG.CLKOUT2_DRIVES {BUFG} \
   CONFIG.CLKOUT2_JITTER {170.632} \
   CONFIG.CLKOUT2_PHASE_ERROR {203.313} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {166.000} \
   CONFIG.CLKOUT2_REQUESTED_PHASE {90} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_DRIVES {BUFG} \
   CONFIG.CLKOUT3_JITTER {170.632} \
   CONFIG.CLKOUT3_PHASE_ERROR {203.313} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {166.000} \
   CONFIG.CLKOUT3_REQUESTED_PHASE {180} \
   CONFIG.CLKOUT3_USED {true} \
   CONFIG.CLKOUT4_DRIVES {BUFG} \
   CONFIG.CLKOUT4_JITTER {170.632} \
   CONFIG.CLKOUT4_PHASE_ERROR {203.313} \
   CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {166.000} \
   CONFIG.CLKOUT4_REQUESTED_PHASE {270} \
   CONFIG.CLKOUT4_USED {true} \
   CONFIG.CLKOUT5_DRIVES {BUFG} \
   CONFIG.CLKOUT5_JITTER {165.598} \
   CONFIG.CLKOUT5_PHASE_ERROR {203.313} \
   CONFIG.CLKOUT5_REQUESTED_OUT_FREQ {200.000} \
   CONFIG.CLKOUT5_USED {true} \
   CONFIG.CLKOUT6_DRIVES {BUFG} \
   CONFIG.CLKOUT7_DRIVES {BUFG} \
   CONFIG.CLK_OUT1_PORT {clk_166MHz} \
   CONFIG.CLK_OUT2_PORT {clk_166MHz_90} \
   CONFIG.CLK_OUT3_PORT {clk_166MHz_180} \
   CONFIG.CLK_OUT4_PORT {clk_166MHz_270} \
   CONFIG.CLK_OUT5_PORT {clk_200MHz} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT4_PORT {clkAxiRpc} \
   CONFIG.JITTER_SEL {No_Jitter} \
  ...
  connect_bd_net -net aresetn_1 [get_bd_ports reset_n] [get_bd_pins axiRpc_reset/ext_reset_in] [get_bd_pins hb_pll/resetn] [get_bd_pins system_pll/resetn] [get_bd_pins system_reset/ext_reset_in]
  ...
  connect_bd_net -net clk_100MHz_1 [get_bd_ports clk_100MHz] [get_bd_pins hb_pll/clk_in1] [get_bd_pins system_pll/clk_in1]
  ...
  connect_bd_net -net clk_wiz_0_clkAxiRpc [get_bd_pins axiRpc_reset/slowest_sync_clk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins rpc2_ctrl_controller_0/AXIm_ACLK] [get_bd_pins system_pll/clkAxiRpc]
  ...
  connect_bd_net -net clk_wiz_1_clk_166MHz [get_bd_pins hb_pll/clk_166MHz] [get_bd_pins rpc2_ctrl_controller_0/rpc_clk166MHz]
  connect_bd_net -net clk_wiz_1_clk_166MHz_90 [get_bd_pins hb_pll/clk_166MHz_90] [get_bd_pins rpc2_ctrl_controller_0/rpc_clk166MHz_90]
  connect_bd_net -net clk_wiz_1_clk_166MHz_180 [get_bd_pins hb_pll/clk_166MHz_180] [get_bd_pins rpc2_ctrl_controller_0/rpc_clk166MHz_180]
  connect_bd_net -net clk_wiz_1_clk_166MHz_270 [get_bd_pins hb_pll/clk_166MHz_270] [get_bd_pins rpc2_ctrl_controller_0/rpc_clk166MHz_270]
  connect_bd_net -net clk_wiz_1_clk_200MHz [get_bd_pins hb_pll/clk_200MHz] [get_bd_pins rpc2_ctrl_controller_0/rpc_clk200MHz]
  ...
  connect_bd_net -net rst_ddr2_mig_0_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins system_reset/mb_reset]
  connect_bd_net -net rst_ddr2_mig_0_100M_peripheral_aresetn [get_bd_pins Lpc_to_AXI_prodcons_0/s00_axi_aresetn] [get_bd_pins Lpc_to_AXI_prodcons_1/s00_axi_aresetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_0_dma/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/S05_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi4_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins mdm_1/M_AXI_ARESETN] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/M10_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins system_reset/peripheral_aresetn]
