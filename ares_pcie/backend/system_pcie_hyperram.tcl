...
proc create_root_design { parentCell } {
  ...
  # Create instance: pci_reset_0, and set properties
  set pci_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 pci_reset_0 ]
  ...
  connect_bd_net -net aresetn_1 [get_bd_ports reset_n] [get_bd_pins pci_reset_0/ext_reset_in] [get_bd_pins reset_100MHz/ext_reset_in] [get_bd_pins rpc_pll/resetn] [get_bd_pins system_pll/resetn]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins pci_reset_0/peripheral_aresetn] [get_bd_pins pcie2AxiMaster_0/pcie_sys_rst_n]
  ...
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_ports pcie_refclk] [get_bd_pins pci_reset_0/slowest_sync_clk] [get_bd_pins pcie2AxiMaster_0/pcie_sys_clk]
