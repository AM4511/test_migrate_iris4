...
set_property PACKAGE_PIN P3 [get_ports {rmii_rxd[1]}]
set_property PACKAGE_PIN M3 [get_ports {rmii_txd[0]}]
set_property PACKAGE_PIN L3 [get_ports {rmii_txd[1]}]
set_property PACKAGE_PIN M1 [get_ports rmii_crs_dv]
...
set_property PACKAGE_PIN M19 [get_ports ref_clk_100MHz]
