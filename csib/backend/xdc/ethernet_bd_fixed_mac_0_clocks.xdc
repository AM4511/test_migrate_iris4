...
set_false_path -from [get_cells {bd_1768_mac_0_core/*managen/conf/int_*reg[*]}] -to $ip_mii_tx_clk
set_false_path -from [get_cells {bd_1768_mac_0_core/*managen/conf/int_*reg[*]}] -to $rx_clk
set_false_path -from [get_cells {bd_1768_mac_0_core/*managen/conf/int_*reg}] -to $ip_mii_tx_clk
set_false_path -from [get_cells {bd_1768_mac_0_core/*managen/conf/int_*reg}] -to $rx_clk
