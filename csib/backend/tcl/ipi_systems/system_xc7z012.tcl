...
proc create_hier_cell_clk_reset_mngr { parentCell nameHier } {
  ...
  connect_bd_net -net Net [get_bd_pins zynq_reset_n] [get_bd_pins ncsi_reset_mngr/aux_reset_in]
  connect_bd_net -net Profinet_axi_clk_100MHz1 [get_bd_pins ref_clk_100MHz] [get_bd_pins eth_pll/clk_in1]
  connect_bd_net -net eth_pll_locked [get_bd_pins eth_pll/locked] [get_bd_pins ncsi_reset_mngr/dcm_locked]
  ...
  connect_bd_net -net zync_soc_FCLK_RESET0_N [get_bd_pins ext_reset_n] [get_bd_pins ncsi_reset_mngr/ext_reset_in]
...
proc create_hier_cell_profinet_system { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk S_AXI_GP0_ACLK
  create_bd_pin -dir O -type clk ncsi_clk_out

  # Create instance: clk_reset_mngr
  create_hier_cell_clk_reset_mngr $hier_obj clk_reset_mngr
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_DCI_PERIPHERAL_FREQMHZ {1.694915} \
   ...
   CONFIG.PCW_ACT_PCAP_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_SMC_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_SPI_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_TPIU_PERIPHERAL_FREQMHZ {200.000000} \
   CONFIG.PCW_ACT_TTC0_CLK0_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_ACT_TTC0_CLK1_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_ACT_TTC0_CLK2_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_ACT_TTC1_CLK0_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_ACT_TTC1_CLK1_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_ACT_TTC1_CLK2_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_ACT_TTC_PERIPHERAL_FREQMHZ {50} \
   CONFIG.PCW_ACT_UART_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_ACT_USB0_PERIPHERAL_FREQMHZ {60} \
   CONFIG.PCW_ACT_USB1_PERIPHERAL_FREQMHZ {60} \
   CONFIG.PCW_ACT_WDT_PERIPHERAL_FREQMHZ {25.000000} \
   CONFIG.PCW_APU_CLK_RATIO_ENABLE {4:2:1} \
   CONFIG.PCW_APU_PERIPHERAL_FREQMHZ {200} \
   CONFIG.PCW_ARMPLL_CTRL_FBDIV {2} \
   ...
   CONFIG.PCW_CPU_CPU_PLL_FREQMHZ {100.000} \
   ...
   CONFIG.PCW_DDRPLL_CTRL_FBDIV {6} \
   CONFIG.PCW_DDR_DDR_PLL_FREQMHZ {300.000} \
   CONFIG.PCW_DDR_HPRLPR_QUEUE_PARTITION {HPR(0)/LPR(32)} \
   CONFIG.PCW_DDR_HPR_TO_CRITICAL_PRIORITY_LEVEL {15} \
   CONFIG.PCW_DDR_LPR_TO_CRITICAL_PRIORITY_LEVEL {2} \
   CONFIG.PCW_DDR_PERIPHERAL_CLKSRC {DDR PLL} \
   CONFIG.PCW_DDR_PERIPHERAL_DIVISOR0 {1} \
   ...
   CONFIG.PCW_IO_IO_PLL_FREQMHZ {50.000} \
   ...
   CONFIG.PCW_QSPI_PERIPHERAL_DIVISOR0 {2} \
   ...
   CONFIG.PCW_UART_PERIPHERAL_DIVISOR0 {2} \
   ...
   CONFIG.PCW_UIPARAM_DDR_PARTNO {MT41J64M16 JT-15E} \
  ...
  connect_bd_intf_net -intf_net Profinet_ddr [get_bd_intf_pins ddr] [get_bd_intf_pins zync_soc/DDR]
  connect_bd_intf_net -intf_net Profinet_fixed_io [get_bd_intf_pins fixed_io] [get_bd_intf_pins zync_soc/FIXED_IO]
  connect_bd_intf_net -intf_net S_AXI_GP0_1 [get_bd_intf_pins S_AXI_GP0] [get_bd_intf_pins zync_soc/S_AXI_GP0]
  ...
  # Create port connections
  connect_bd_net -net PCIE_RESET_N_1 [get_bd_pins SYS_RESET_N] [get_bd_pins clk_reset_mngr/ext_reset_n]
  connect_bd_net -net S_AXI_GP0_ACLK_0_1 [get_bd_pins S_AXI_GP0_ACLK] [get_bd_pins zync_soc/S_AXI_GP0_ACLK]
  ...
  connect_bd_net -net clk_reset_mngr_ncsi_clk50MHz_out [get_bd_pins ncsi_clk_out] [get_bd_pins clk_reset_mngr/ncsi_clk50MHz_io]
...
proc create_root_design { parentCell } {
  ...
  set ext_sync_1 [ create_bd_intf_port -mode Master -vlnv matrox.com:user:ext_sync_rtl:1.0 ext_sync_1 ]
  ...
  connect_bd_intf_net -intf_net Profinet_ddr [get_bd_intf_ports ddr] [get_bd_intf_pins profinet_system/ddr]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins profinet_system/S_AXI_GP0]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins hispi_line_writer/s_axi]
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axiMaio_0/axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins hispi_line_writer/axi_clk] [get_bd_pins pcie_axi_reset/slowest_sync_clk] [get_bd_pins profinet_system/S_AXI_GP0_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axiMaio_0/axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins hispi_line_writer/axi_reset_n] [get_bd_pins pcie_axi_reset/interconnect_aresetn] [get_bd_pins profinet_system/SYS_RESET_N]
  ...
  create_bd_addr_seg -range 0x00004000 -offset 0x40000000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_pcie_0/S_AXI_CTL/CTL0] SEG_axi_pcie_0_CTL0
  create_bd_addr_seg -range 0x08000000 -offset 0x00000000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs profinet_system/zync_soc/S_AXI_GP0/GP0_DDR_LOWOCM] SEG_zync_soc_GP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs profinet_system/zync_soc/S_AXI_GP0/GP0_IOP] SEG_zync_soc_GP0_IOP
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs profinet_system/zync_soc/S_AXI_GP0/GP0_QSPI_LINEAR] SEG_zync_soc_GP0_QSPI_LINEAR
  create_bd_addr_seg -range 0x04000000 -offset 0x80000000 [get_bd_addr_spaces hispi_line_writer/axi_mm2s_mapper_0/Bridge] [get_bd_addr_segs axi_pcie_0/S_AXI/BAR0] SEG_axi_pcie_0_BAR0
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0x00000000 [get_bd_addr_spaces hispi_line_writer/axi_mm2s_mapper_0/Bridge] [get_bd_addr_segs profinet_system/zync_soc/S_AXI_GP0/GP0_DDR_LOWOCM] SEG_zync_soc_GP0_DDR_LOWOCM
  exclude_bd_addr_seg [get_bd_addr_segs hispi_line_writer/axi_mm2s_mapper_0/Bridge/SEG_zync_soc_GP0_DDR_LOWOCM]

  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces hispi_line_writer/axi_mm2s_mapper_0/Bridge] [get_bd_addr_segs profinet_system/zync_soc/S_AXI_GP0/GP0_IOP] SEG_zync_soc_GP0_IOP
  exclude_bd_addr_seg [get_bd_addr_segs hispi_line_writer/axi_mm2s_mapper_0/Bridge/SEG_zync_soc_GP0_IOP]

  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces hispi_line_writer/axi_mm2s_mapper_0/Bridge] [get_bd_addr_segs profinet_system/zync_soc/S_AXI_GP0/GP0_QSPI_LINEAR] SEG_zync_soc_GP0_QSPI_LINEAR
