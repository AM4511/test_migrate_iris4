...
proc create_hier_cell_interrupt_mapping { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 7 -to 0 irq_qspi
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00008000 -offset 0x90000000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axiMaio_0/s_axi/reg0] SEG_axiMaio_0_reg0
  create_bd_addr_seg -range 0x01000000 -offset 0x80000000 [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_pcie_0/S_AXI_CTL/CTL0] SEG_axi_pcie_0_CTL0
  ...
  create_bd_addr_seg -range 0x00008000 -offset 0x90000000 [get_bd_addr_spaces hispi_line_writer/axi_mm2s_mapper_0/Bridge] [get_bd_addr_segs axiMaio_0/s_axi/reg0] SEG_axiMaio_0_reg0
  exclude_bd_addr_seg [get_bd_addr_segs hispi_line_writer/axi_mm2s_mapper_0/Bridge/SEG_axiMaio_0_reg0]

  create_bd_addr_seg -range 0x01000000 -offset 0x80000000 [get_bd_addr_spaces hispi_line_writer/axi_mm2s_mapper_0/Bridge] [get_bd_addr_segs axi_pcie_0/S_AXI_CTL/CTL0] SEG_axi_pcie_0_CTL0
