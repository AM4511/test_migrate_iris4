...
set_clock_groups -group [get_clocks -of_objects [get_pins xsystem_pb_wrapper/system_pb_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]] -group hispi_serial_clk_p_0 -asynchronous;
set_clock_groups -group [get_clocks -of_objects [get_pins xsystem_pb_wrapper/system_pb_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]] -group hispi_serial_clk_p_1 -asynchronous;
set_clock_groups -group [get_clocks -of_objects [get_pins xsystem_pb_wrapper/system_pb_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]] -group hispi_serial_clk_p_2 -asynchronous;
set_clock_groups -group [get_clocks -of_objects [get_pins xsystem_pb_wrapper/system_pb_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]] -group hispi_serial_clk_p_3 -asynchronous;
set_clock_groups -group [get_clocks -of_objects [get_pins xsystem_pb_wrapper/system_pb_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]] -group hispi_serial_clk_p_4 -asynchronous;
set_clock_groups -group [get_clocks -of_objects [get_pins xsystem_pb_wrapper/system_pb_i/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0]] -group hispi_serial_clk_p_5 -asynchronous;
