...
#
# Example      : source $env(CSIB)/backend/csib_xc7z015/create_csib_xc7z015.tcl
#
# ##################################################################################
...
set BASE_NAME  csib_xc7z015
set DEVICE "xc7z015iclg485-1L"
...
set BACKEND_DIR ${WORKDIR}/backend/csib_xc7z015
