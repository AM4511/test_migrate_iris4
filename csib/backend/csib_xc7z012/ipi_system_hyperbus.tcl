...
# Hierarchical cell: clk_ncsi
proc create_hier_cell_clk_ncsi { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_clk_ncsi() - Empty argument(s)!"}
     return
  }
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT3_PORT {axi_clk_100MHz} \
  ...
  connect_bd_net -net axi_reset_mngr_peripheral_aresetn [get_bd_pins axi_reset_n] [get_bd_pins axi_reset_mngr/peripheral_aresetn]
  connect_bd_net -net eth_pll_axi_clk_100MHz [get_bd_pins axi_clk_100MHz_0] [get_bd_pins axi_reset_mngr/slowest_sync_clk] [get_bd_pins eth_pll/axi_clk_100MHz]
...
proc create_hier_cell_profinet_system { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:rmii_rtl:1.0 profinet
  ...
  create_bd_pin -dir O -type clk ncsi_clk_out
  create_bd_pin -dir I -type clk s_pcie_clk
  create_bd_pin -dir I -type rst s_pcie_reset_n

  # Create instance: axi_interconnect_1, and set properties
  set axi_interconnect_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect_1 ]

  # Create instance: clk_ncsi
  create_hier_cell_clk_ncsi $hier_obj clk_ncsi

  # Create instance: hyperbus_ctrl, and set properties
  set hyperbus_ctrl [ create_bd_cell -type ip -vlnv matrox.com:Imaging:rpc2_ctrl_controller:1.0 hyperbus_ctrl ]
  set_property -dict [ list \
   CONFIG.C_AXI_MEM_ADDR_WIDTH {20} \
   CONFIG.C_AXI_MEM_DATA_INTERLEAVING {false} \
   CONFIG.C_AXI_MEM_DATA_WIDTH {32} \
   CONFIG.C_AXI_MEM_ID_WIDTH {8} \
   CONFIG.C_AXI_MEM_LEN_WIDTH {4} \
   CONFIG.C_AXI_REG_ADDR_WIDTH {7} \
   CONFIG.C_AXI_REG_DATA_WIDTH {32} \
   CONFIG.C_AXI_REG_ID_WIDTH {8} \
   CONFIG.C_AXI_REG_LEN_WIDTH {4} \
   CONFIG.C_MEM_AR_FIFO_ADDR_BITS {4} \
   CONFIG.C_MEM_AW_FIFO_ADDR_BITS {4} \
   CONFIG.C_MEM_RDAT_FIFO_ADDR_BITS {7} \
   CONFIG.C_MEM_WDAT_FIFO_ADDR_BITS {7} \
   CONFIG.C_RX_FIFO_ADDR_BITS {8} \
   CONFIG.DPRAM_MACRO {true} \
   CONFIG.DPRAM_MACRO_TYPE {1} \
 ] $hyperbus_ctrl
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins m_zynq_to_pciectrl] [get_bd_intf_pins zync_soc/M_AXI_GP1]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins hyperbus_ctrl/AXIm]
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins hyperbus_ctrl/AXIr]
  connect_bd_intf_net -intf_net mii_to_rmii_0_RMII_PHY_M [get_bd_intf_pins profinet] [get_bd_intf_pins profinet1_mii_to_rmii/RMII_PHY_M]
  ...
  connect_bd_intf_net -intf_net zync_soc_M_AXI_GP0 [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins zync_soc/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net M01_ARESETN_1 [get_bd_pins axi_reset_n] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins clk_ncsi/axi_reset_n] [get_bd_pins hyperbus_ctrl/AXIm_ARESETN] [get_bd_pins hyperbus_ctrl/AXIr_ARESETN]
  connect_bd_net -net M_AXI_GP1_ACLK_0_1 [get_bd_pins m_pciectrl_clk] [get_bd_pins zync_soc/M_AXI_GP1_ACLK]
  connect_bd_net -net Net [get_bd_pins RPC_DQ] [get_bd_pins hyperbus_ctrl/RPC_DQ]
  connect_bd_net -net Net1 [get_bd_pins RPC_RWDS] [get_bd_pins hyperbus_ctrl/RPC_RWDS]
  connect_bd_net -net RPC_INT_N_0_1 [get_bd_pins RPC_INT_N] [get_bd_pins hyperbus_ctrl/RPC_INT_N]
  connect_bd_net -net RPC_RSTO_N_0_1 [get_bd_pins RPC_RSTO_N] [get_bd_pins hyperbus_ctrl/RPC_RSTO_N]
  connect_bd_net -net clk_ncsi_axi_clk_100MHz_0 [get_bd_pins axi_clk_100MHz_0] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins clk_ncsi/axi_clk_100MHz_0] [get_bd_pins hyperbus_ctrl/AXIm_ACLK] [get_bd_pins hyperbus_ctrl/AXIr_ACLK] [get_bd_pins hyperbus_ctrl/ref_clk] [get_bd_pins hyperbus_ctrl/sys_clk] [get_bd_pins zync_soc/M_AXI_GP0_ACLK]
  connect_bd_net -net clk_reset_mngr_ncsi_clk50MHz [get_bd_pins clk_ncsi/ncsi_clk50MHz] [get_bd_pins profinet1_mii_to_rmii/ref_clk]
  connect_bd_net -net clk_reset_mngr_ncsi_clk50MHz_out [get_bd_pins ncsi_clk_out] [get_bd_pins clk_ncsi/ncsi_clk50MHz_io]
  connect_bd_net -net clk_reset_mngr_ncsi_reset_n [get_bd_pins clk_ncsi/ncsi_reset_n] [get_bd_pins profinet1_mii_to_rmii/rst_n]
  connect_bd_net -net rpc2_ctrl_controller_0_RPC_CK [get_bd_pins RPC_CK] [get_bd_pins hyperbus_ctrl/RPC_CK]
  connect_bd_net -net rpc2_ctrl_controller_0_RPC_CK_N [get_bd_pins RPC_CK_N] [get_bd_pins hyperbus_ctrl/RPC_CK_N]
  connect_bd_net -net rpc2_ctrl_controller_0_RPC_CS0_N [get_bd_pins RPC_CS0_N] [get_bd_pins hyperbus_ctrl/RPC_CS0_N]
  connect_bd_net -net rpc2_ctrl_controller_0_RPC_CS1_N [get_bd_pins RPC_CS1_N] [get_bd_pins hyperbus_ctrl/RPC_CS1_N]
  connect_bd_net -net rpc2_ctrl_controller_0_RPC_RESET_N [get_bd_pins RPC_RESET_N] [get_bd_pins hyperbus_ctrl/RPC_RESET_N]
  connect_bd_net -net rpc2_ctrl_controller_0_RPC_WP_N [get_bd_pins RPC_WP_N] [get_bd_pins hyperbus_ctrl/RPC_WP_N]
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_pins s_pcie_reset_n] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins clk_ncsi/ext_reset_n]
  connect_bd_net -net s_pcie_clk_1 [get_bd_pins s_pcie_clk] [get_bd_pins axi_interconnect_1/ACLK]
  connect_bd_net -net zync_soc_FCLK_CLK0 [get_bd_pins clk_ncsi/ref_clk_100MHz] [get_bd_pins zync_soc/FCLK_CLK0]
  connect_bd_net -net zync_soc_FCLK_RESET0_N [get_bd_pins clk_ncsi/zynq_reset_n] [get_bd_pins zync_soc/FCLK_RESET0_N]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net mii_to_rmii_0_RMII_PHY_M [get_bd_intf_ports profinet] [get_bd_intf_pins profinet_system/profinet]
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axiMaio_0/axi_aclk] [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins axi_pcie_interconnect/ACLK] [get_bd_pins axi_pcie_interconnect/M00_ACLK] [get_bd_pins axi_pcie_interconnect/M01_ACLK] [get_bd_pins axi_pcie_interconnect/S00_ACLK] [get_bd_pins hispi_line_writer/axi_clk] [get_bd_pins pcie_axi_reset/slowest_sync_clk] [get_bd_pins profinet_system/s_pcie_clk]
  ...
  connect_bd_net -net clk_reset_mngr_ncsi_clk50MHz_out [get_bd_ports ncsi_clk_out] [get_bd_pins profinet_system/ncsi_clk_out]
  ...
  create_bd_addr_seg -range 0x04000000 -offset 0x40000000 [get_bd_addr_spaces profinet_system/zync_soc/Data] [get_bd_addr_segs profinet_system/hyperbus_ctrl/AXIm/reg0] SEG_hyperbus_ctrl_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x44000000 [get_bd_addr_spaces profinet_system/zync_soc/Data] [get_bd_addr_segs profinet_system/hyperbus_ctrl/AXIr/reg0] SEG_hyperbus_ctrl_reg03
