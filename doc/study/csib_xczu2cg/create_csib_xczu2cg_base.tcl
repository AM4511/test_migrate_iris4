...
# Targeted device : xczu2cg-sbva484-1LV-i
#
# Example         : source $env(CSIB)/backend/csib_xczu2cg/create_csib_xczu2cg_base.tcl
#
# ##################################################################################
...
set BASE_NAME  csib_xczu2cg
set DEVICE "xczu2cg-sbva484-1LV-i"
...
set BACKEND_DIR ${WORKDIR}/backend/csib_xczu2cg
