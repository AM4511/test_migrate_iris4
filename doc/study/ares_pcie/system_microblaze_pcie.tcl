...
proc create_hier_cell_profinet_system { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type clk ref_clk_50MHz
  ...
  connect_bd_net -net PCIE_RESET_N_1 [get_bd_pins ext_rst_n] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  ...
  connect_bd_net -net clk_wiz_0_ref_clk_50MHz [get_bd_pins ref_clk_50MHz] [get_bd_pins clk_wiz_0/ref_clk_50MHz] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins sect_profinet/ncsi_clk_50MHz]
  connect_bd_net -net gtx_clk_125MHz_1 [get_bd_pins clk_wiz_0/ref_clk_125MHz] [get_bd_pins sect_profinet/gtx_clk_125MHz]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/ref_clk_100MHz] [get_bd_pins mailbox_0/S1_AXI_ACLK] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/Clk] [get_bd_pins rpc2_ctrl_controller_0/AXIm_ACLK] [get_bd_pins rpc2_ctrl_controller_0/AXIr_ACLK] [get_bd_pins rpc2_ctrl_controller_0/ref_clk] [get_bd_pins rpc2_ctrl_controller_0/sys_clk] [get_bd_pins rst_Clk_100M/slowest_sync_clk] [get_bd_pins sect_profinet/sysclk_100MHz]
  ...
  connect_bd_net -net ref_clk_100MHz_1 [get_bd_pins ref_clk_100MHz] [get_bd_pins clk_wiz_0/clk_in1]
...
proc create_hier_cell_pcie_host_system { parentCell nameHier } {
  ...
  # Create interface pins
  create_bd_intf_pin -mode Slave -vlnv matrox.com:Imaging:FPGA_Info_rtl:1.0 FPGA_Info_0
  ...
  create_bd_intf_pin -mode Master -vlnv matrox.com:MatroxIP:mtxSPI_rtl:1.0 mtxSPI_0
  ...
  # Create pins
  create_bd_pin -dir O mbox_clk
  create_bd_pin -dir O mbox_reset_n
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins FPGA_Info_0] [get_bd_intf_pins pcie2AxiMaster_0/FPGA_Info]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins pcie_mgt_0] [get_bd_intf_pins pcie2AxiMaster_0/pcie_mgt]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins mtxSPI_0] [get_bd_intf_pins pcie2AxiMaster_0/mtxSPI]
  ...
  # Create port connections
  connect_bd_net -net aclk_0_1 [get_bd_pins mbox_clk] [get_bd_pins axiMaio_0/axi_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins pcie2AxiMaster_0/axim_clk]
  connect_bd_net -net aresetn_0_1 [get_bd_pins mbox_reset_n] [get_bd_pins axiMaio_0/axi_aresetn] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins pcie2AxiMaster_0/axim_rst_n]
  ...
  connect_bd_net -net pcie_clk_1 [get_bd_pins pcie_clk] [get_bd_pins pcie2AxiMaster_0/pcie_sys_clk]
  connect_bd_net -net pcie_reset_n_1 [get_bd_pins pcie_reset_n] [get_bd_pins pcie2AxiMaster_0/pcie_sys_rst_n]
