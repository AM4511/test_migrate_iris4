...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set irq_event_0 [ create_bd_port -dir O irq_event_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_DCI_PERIPHERAL_FREQMHZ {2.542373} \
   ...
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {50.000000} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#unassigned#unassigned#Unbonded#Unbonded#unassigned#unassigned} \
   CONFIG.PCW_MIO_TREE_SIGNALS {unassigned#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#unassigned#unassigned#Unbonded#Unbonded#unassigned#unassigned} \
   ...
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY0 {0.237} \
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY1 {0.220} \
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY2 {0.468} \
   CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY3 {0.583} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_0 {0.096} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_1 {0.129} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_2 {-0.334} \
   CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_3 {-0.514} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins zync_soc/S_AXI_GP0]
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axiMaio_0/s_axi] [get_bd_intf_pins axi_interconnect_1/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net Profinet_axi_clk_100MHz1 [get_bd_pins axiMaio_0/axi_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins clk_reset_mngr/axi_clk_100MHz] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins zync_soc/S_AXI_GP0_ACLK]
  ...
  connect_bd_net -net interrupt_mapping_irq_event [get_bd_ports irq_event_0] [get_bd_pins interrupt_mapping/irq_event]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axiMaio_0/axi_aresetn] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins clk_reset_mngr/axi_reset_n] [get_bd_pins jtag_axi_0/aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs axiMaio_0/s_axi/reg0] SEG_axiMaio_0_reg0
  create_bd_addr_seg -range 0x08000000 -offset 0x00000000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs zync_soc/S_AXI_GP0/GP0_DDR_LOWOCM] SEG_zync_soc_GP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs zync_soc/S_AXI_GP0/GP0_IOP] SEG_zync_soc_GP0_IOP
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs zync_soc/S_AXI_GP0/GP0_QSPI_LINEAR] SEG_zync_soc_GP0_QSPI_LINEAR
