...
#
# Example      : source $env(CSIB)/backend/csib_xc7a50t/create_csib_xc7a50t.tcl
#
# ##################################################################################
...
set BACKEND_DIR ${WORKDIR}/backend/csib_xc7a50t
...
set FILESET_SCRIPT     ${TCL_DIR}/csib_add_files.tcl
